 ...
 * Author: drew
 *
 * Created on July 21, 2021, 7:56 PM
 */
...
void intAdd(signed int num1, signed int num2);
void intSub(signed int num1, signed int num2);
//void intMult(signed int num1, signed int num2);
